package org.jeecg.modules.pavilion.vo;
 ...
 */
@Data
@ApiModel(value="pavilion_goodPage对象", description="商品")
public class PavilionGoodPage {
	...
	@ExcelCollection(name="商品图片信息")
	@ApiModelProperty(value = "商品图片信息")
	private List<PavilionGoodImage> pavilionGoodImageList;
